...
set output "CHM13_chr17def.svg"
plot "< gawk 'NR>2' ./def.vars.dat | tr ACGT 0123" u (200*$1)+($2)+(0.25*$3):5 w imp

set output "CHM13_chr1714m.svg"
plot "< gawk 'NR>2' ./14m.vars.dat | tr ACGT 0123" u (200*$1)+($2)+(0.25*$3):5 w imp
